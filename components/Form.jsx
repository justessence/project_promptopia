      ...
      <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2x1 flex flex-col gap-7 glassmorphism">
        ...
        <label>
          <span className='font-satoshi font-semibold text-base text-gray-700'>
            Tag
            <span className='font-normal'> (#product, #webdevelopment, #idea, #coolstuff)</span>
          </span>
          <input 
            value={post.tag} 
        ...
        <div className='flex-end mx-3 mb-5 gap-4'>
          ...
          <button type="submit" disabled={sumbitting} className="px-5 py-1.5 text-sm bg-primary-orange rounded-full text-white">
